    ...
    <div id="projects">
      ...
      <div className="flex-wrap gap-4 space-y-4 lg:flex lg:space-y-0">
        ...
        >
          ...
          <p className="mt-3 text-left text-sm text-neutral-200">
            {cards.a.text}
          </p>
        </WobbleCard>
        <WobbleCard
          style={{ backgroundColor: data?.[9] ?? "#235147" }}
        ...
        >
          ...
          <div className="mt-3 max-w-[700px] text-left text-sm text-neutral-200">
            {cards.b.text}
          </div>
        </WobbleCard>
